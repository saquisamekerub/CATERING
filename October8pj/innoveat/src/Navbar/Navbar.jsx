      ...
      <div className="container-fluid">
        <div className="navbar d-flex justify-content-between align-items-center px-4 py-2">
          ...
          <div className="nav-links d-flex align-items-center">
            <Link to="/Calendars" className="button">Calendars</Link>
            <Link to="/TransactionHistory" className="button">TransactionHistory</Link>
            <Link to="/Orders" className="button">Orders</Link>
            <Link to="/EventChart" className="button">EventChart</Link>
